namespace HospitalDbExtended.Utilities
{
    public static class ErrorMessages
    {
        ...
        public const string PatientWithNameNotFound = "No patient of yours with name {0} was found.";
        public const string PatientDoesNotHaveVisitations = "The patient has not been visited by you so a {0} is not possible.";
